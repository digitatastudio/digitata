...
export default function MentoringForm({ onSuccess }: MentoringFormProps) {
  ...
  return (
    // scrollovatelný wrapper – FORM se vejde do viewportu
    <div className="max-h-[80vh] overflow-y-auto px-1 py-2 scrollbar-thin">
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <div>
          <label htmlFor="goal" className="block font-semibold mb-1">
            Co řešíš / kam se chceš posunout?
          </label>
          <textarea
            id="goal"
            name="goal"
